...
workbox.routing.registerRoute("/api/todos/:id", workbox.strategies.networkOnly({ plugins: [new workbox.backgroundSync.Plugin("failedDeleteQueue", {"maxRetentionTime":1440})] }), 'DELETE');
